...
public class CommentController extends BaseInfoProperties {
    ...
    @GetMapping("counts")
    public GraceJSONResult counts(@RequestParam Long vlogId) {
    ...
    @GetMapping("list")
    public GraceJSONResult list(@RequestParam Long vlogId,
    ...
    public GraceJSONResult delete(@RequestParam Long commentUserId,
    ...
    @PostMapping("like")
    public GraceJSONResult like(@RequestParam Long commentId,
                                @RequestParam Long userId) {

        // 故意犯错，bigkey
        redis.incrementHash(REDIS_VLOG_COMMENT_LIKED_COUNTS, commentId.toString(), 1);//累加评论被喜欢的数量
...
//                msgContent);
    ...
    @PostMapping("unlike")
    public GraceJSONResult unlike(@RequestParam Long commentId,
                                  @RequestParam Long userId) {

        redis.decrementHash(REDIS_VLOG_COMMENT_LIKED_COUNTS, commentId.toString(), 1);//评论被喜欢的数量减1
